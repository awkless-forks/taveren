...
typedef struct {
  ...
  __DECLARE_VAR(STRING,_TMP_CONCAT2_OUT)
  __DECLARE_VAR(STRING,_TMP_CONCAT22_OUT)
  __DECLARE_VAR(INT,_TMP_STRING_TO_INT25_OUT)
  __DECLARE_VAR(BOOL,_TMP_INT_TO_BOOL26_OUT)
...
typedef struct {
  ...
  PYTHON_EVAL SETSTATE_COMMAND;
  __DECLARE_VAR(STRING,_TMP_CONCAT1_OUT)
  __DECLARE_VAR(BOOL,_TMP_AND31_OUT)
  __DECLARE_VAR(STRING,_TMP_CONCAT12_OUT)
