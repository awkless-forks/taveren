...
void TRAFFIC_LIGHT_SEQUENCE_init__(TRAFFIC_LIGHT_SEQUENCE *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->OR35_OUT,__BOOL_LITERAL(FALSE),retain)
  UINT i;
  data__->__nb_steps = 6;
...
void TRAFFIC_LIGHT_SEQUENCE_body__(TRAFFIC_LIGHT_SEQUENCE *data__) {
  ...
  if (__GET_VAR(data__->GREEN.X)) {
    __SET_VAR(data__->,__transition_list[6],,__GET_VAR(data__->OR35_OUT,));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[6],,__GET_VAR(data__->OR35_OUT,));
    }
  ...
  if (__GET_VAR(data__->RED.X)) {
    __SET_VAR(data__->,__transition_list[9],,__GET_VAR(data__->NOT42_OUT,));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[9],,__GET_VAR(data__->NOT42_OUT,));
    }
    __SET_VAR(data__->,__transition_list[9],,0);
  }
  if (__GET_VAR(data__->ORANGE.X)) {
    __SET_VAR(data__->,__transition_list[10],,__GET_VAR(data__->NOT42_OUT,));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[10],,__GET_VAR(data__->NOT42_OUT,));
    }
  ...
  // PEDESTRIAN_GREEN action associations
  {
    ...
    if (active && __time_cmp(data__->PEDESTRIAN_GREEN.T.value, __time_to_timespec(1, 0, 2, 0, 0, 0)) >= 0) 
  ...
  // PEDESTRIAN_RED action associations
  {
    ...
    if (active && __time_cmp(data__->PEDESTRIAN_RED.T.value, __time_to_timespec(1, 0, 0, 0, 0, 0)) >= 0) 
  ...
  if(__GET_VAR(data__->__action_list[__SFC_COMPUTE_FUNCTION_BLOCKS].state)) {
    __SET_VAR(data__->,NOT42_OUT,,!(__GET_VAR(data__->SWITCH_BUTTON,)));
    ...
    __SET_VAR(data__->,OR35_OUT,,OR__BOOL__BOOL(
      (BOOL)__BOOL_LITERAL(TRUE),
      NULL,
      (UINT)2,
