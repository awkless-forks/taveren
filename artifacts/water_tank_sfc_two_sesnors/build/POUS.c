...
void WATER_TANK_SFC_init__(WATER_TANK_SFC *data__, BOOL retain) {
  __INIT_VAR(data__->LOW_LEVEL_SENSOR,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->HIGH_LEVEL_SENSOR,__BOOL_LITERAL(FALSE),retain)
...
void WATER_TANK_SFC_body__(WATER_TANK_SFC *data__) {
  ...
  if (__GET_VAR(data__->INITIALIZE.X)) {
    __SET_VAR(data__->,__transition_list[0],,__GET_VAR(data__->LOW_LEVEL_SENSOR,));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[0],,__GET_VAR(data__->LOW_LEVEL_SENSOR,));
    }
    __SET_VAR(data__->,__transition_list[0],,0);
  }
  if (__GET_VAR(data__->FILL_TANK.X)) {
    __SET_VAR(data__->,__transition_list[1],,__GET_VAR(data__->HIGH_LEVEL_SENSOR,));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[1],,__GET_VAR(data__->HIGH_LEVEL_SENSOR,));
    }
    __SET_VAR(data__->,__transition_list[1],,0);
  }
  if (__GET_VAR(data__->STOP_MOTOR.X)) {
    __SET_VAR(data__->,__transition_list[2],,__GET_VAR(data__->LOW_LEVEL_SENSOR,));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[2],,__GET_VAR(data__->LOW_LEVEL_SENSOR,));
    }
  ...
  // INITIALIZE action associations
  {
    ...
    if (active)       {data__->__action_list[__SFC_PUMP].reset = 1;}
  ...
  // FILL_TANK action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,PUMP,,1);};
    if (desactivated) {__SET_VAR(data__->,PUMP,,0);};
  ...
  // Actions execution
  if (data__->__action_list[__SFC_PUMP].reset) {
    __SET_VAR(data__->,PUMP,,0);
  }
  else if (data__->__action_list[__SFC_PUMP].set) {
    __SET_VAR(data__->,PUMP,,1);
  }
