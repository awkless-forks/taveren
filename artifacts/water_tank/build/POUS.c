...
void WATER_TANK_body__(WATER_TANK *data__) {
  ...
  __SET_VAR(data__->SR0.,S1,,__GET_VAR(data__->LOW_LEVEL_SENSOR,));
  __SET_VAR(data__->SR0.,R,,__GET_VAR(data__->HIGH_LEVEL_SENSOR,));
  SR_body__(&data__->SR0);
  __SET_VAR(data__->,PUMP,,__GET_VAR(data__->SR0.Q1,));
