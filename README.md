...
* The environment model that describes the interaction of the PLC with the physical world, which includes the addresses, sizes and types for input (sensor) and output (actuator) variables (user input, see [example](packaging/test/packaging.json#L49-L120))
...
* Safety policies (user input, see [example](packaging/test/test_packaging.py#L33-L58))
