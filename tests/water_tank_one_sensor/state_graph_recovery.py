...
class StateGraphRecoveryAnalysis(Analysis):
    ...
    def __init__(self, func: 'Function', fields: 'AbstractStateFields', software: str,
        ...
        self.water_level_info = inputs["WATER_LEVEL"]
    ...
    def traverse(self):
        ...
        symbolic_water_level = self._symbolize_water_level(init_state)
        ...
        while state_queue:
            ...
            if water_level_delta is not None:
                self._advance_water_level(prev_state, water_level_delta)
